...
public class Lzma2Stream : Stream
{
    ...
    // Compress mode state
    private readonly Lzma2Options? options;
            ...
            bool leaveOpen = false)
    {
        ...
        {
            this.options = options ?? new Lzma2Options();
        ...
        {
            this.decompressPropertyHeader = ZevenFormat.ReadHeaderAndValidateCodec(stream, CodecId.Lzma2);
        }
    }
        ...
        if (disposing)
        {
            try
            {
                if (this.mode == CompressionMode.Compress)
                {
                    ...
                    {
                        ZevenFormat.WriteHeader(this.innerStream, CodecId.Lzma2, this.propertyHeader!);
    ...
    private void LoadNextChunk()
    {
        ...
        Codec.DecompressBlock(this.decompressPropertyHeader!, CodecId.Lzma2,

...
/// <summary>
/// Incremental LZ4 compression/decompression stream matching the DeflateStream pattern.
...
public class Lz4Stream : Stream
{
    ...
    // Compress mode state
    private readonly Lz4Options? options;
            ...
            bool leaveOpen = false)
    {
        ...
        {
            this.options = options ?? new Lz4Options();
        ...
        {
            this.decompressPropertyHeader = ZevenFormat.ReadHeaderAndValidateCodec(stream, CodecId.Lz4);
        }
    }
    ...
    private void LoadNextChunk()
    {
        ...
        Codec.DecompressBlock(this.decompressPropertyHeader!, CodecId.Lz4,

...
/// <summary>
/// Incremental Zstd compression/decompression stream matching the DeflateStream pattern.
...
public class ZstdStream : Stream
{
    ...
    // Compress mode state
    private readonly ZstdOptions? options;
            ...
            bool leaveOpen = false)
    {
        ...
        {
            this.options = options ?? new ZstdOptions();
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        if (disposing)
        {
            if (this.mode == CompressionMode.Compress)
            {
                ...
                {
                    ZevenFormat.WriteHeader(this.innerStream, CodecId.Zstd, this.propertyHeader!);
    ...
    private void LoadNextChunk()
    {
        ...
        Codec.DecompressBlock(this.decompressPropertyHeader!, CodecId.Zstd,
